...
/**
 * Created by qgl on 2018/4/3.
 */

public class MyDialog1 extends CustomDialog1 implements View.OnClickListener {
    ...
    public MyDialog1(Context context, boolean hasContentView, boolean dimEnabled, float width) {
    ...
    private MyDialog1(Context context, boolean dimEnabled) {
        super(context, dimEnabled);
    }
...
//        setCanceledOnTouchOutside(false);
     ...
     * 设置按钮vaule
     */
    public MyDialog1 setButtonText(String text1, String text2) {
        this.text1 = text1;
        this.text2 = text2;
        return this;
    }

    public MyDialog1 setCanceledOnTouch(boolean cancel) {
     ...
     * @param messageStr
     */
    public MyDialog1 setMessageStr(CharSequence messageStr) {
        this.messageStr = messageStr;
        return this;
    }

    public MyDialog1 setMessageStr(CharSequence messageStr, int gravity) {
        this.messageStr = messageStr;
     ...
     * @param titleStr
     */
    public MyDialog1 setTitleStr(CharSequence titleStr) {
...
//按钮2
     ...
     * @param clickListener
     */
    public MyDialog1 setClickListener(ButtonOnClickListener clickListener) {
     ...
     * @param addView
     */
    public MyDialog1 setNewView(View addView) {
