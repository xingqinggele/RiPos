...
import com.example.ripos.homefragment.homeequipment.fragment.transfer.SelectTransferFragment;
...
import com.example.ripos.mefragment.meorder.adapter.MeExchangeAdapter;
...
public class MeExchangeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public void initList() {
        ...
        //adapter配置data
        meExchangeAdapter = new MeExchangeAdapter(R.layout.item_me_exchange, mData);
        //打开加载动画
