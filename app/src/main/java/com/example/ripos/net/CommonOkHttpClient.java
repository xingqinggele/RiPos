...
import com.example.ripos.app.MyApp;
...
public class CommonOkHttpClient {
   ...
   * POST请求图片
   */
  public static Call downLadImg(Request request, final String imgPath, final ResponseByteCallback callback) {
    Call call = mOkHttpClient.newCall(request);
    call.enqueue(new Callback() {
      ...
      public void onResponse(Call call, Response response) throws IOException {
        ...
        try {
          ...
          int len = 0;
          // 文件夹路径
          String pathUrl = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "/sgcc/";
