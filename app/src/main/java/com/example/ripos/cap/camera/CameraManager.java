...
package com.example.ripos.cap.camera;
...
import com.example.ripos.cap.android.CaptureActivityHandler;
...
//    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = (int) (screenResolutionX * 0.8);
            int width1 = (int) (screenResolutionX * 0.2);
            int height = width1;
